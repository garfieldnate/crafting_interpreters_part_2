...
static Token makeToken(TokenType type) {
  ...
  // note: for mult-line strings, this sets the token to the last line the
  // string was on, not the first
...
// The code forms a trie/FSM searching for Lox keywords; if none are found, then
// we have a user-defined identifier
